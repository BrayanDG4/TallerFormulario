            ...
            >
                ...
                <h1 class="text-center text-3xl font-bold text-red-500">Eliminar Usuario</h1>
                    ...
                    <div class="mb-5">
                        ...
                        <input value="David Suarez" name="name" type="text" id="name" placeholder="Nombre" 
                    ...
                    <div class="mb-5">
                        ...
                        <input value="dsuarez" name="username" type="text" id="username" placeholder="Nombre de usuario" 
                        class="border p-3 w-full rounded-lg"/>
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <input value="dsuarez@unicesar.edu.co" name="email" type="email" id="email" placeholder="Correo electrónico" 
                        class="border p-3 w-full rounded-lg"/>
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <input value="texto" name="password" type="password" id="password" placeholder="Contraseña" 
                        class="border p-3 w-full rounded-lg"/>
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <input value="texto" name="password_confirmation" type="password" id="password_confirmation" placeholder="Repetir contraseña" 
                        class="border p-3 w-full rounded-lg"/>
                    </div>
